...
namespace rec Fable.Formatting.Markdown

open System.Collections.Generic
//open Fable.Formatting.Templating


type FableTextWriter() =
    let mutable buffer = ""
    member _.Write(s:string) = buffer <- buffer + s
    override _.ToString() = buffer
