...
/// [omit]
module Fable.Formatting.Markdown.HtmlFormatting

open System
open System.IO
open System.Collections.Generic
open System.Text.RegularExpressions
open Fable.Formatting.Patterns
...
type internal FormattingContext =
  { LineBreak : unit -> unit
    Newline : string
    Writer : Fable.Formatting.Markdown.FableTextWriter
